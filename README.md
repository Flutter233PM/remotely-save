...
[![downloads of latest version](https://img.shields.io/github/downloads-pre/Flutter233PM/remotely-save/latest/main.js?sort=semver)](https://github.com/Flutter233PM/remotely-save/releases)
...
- Option #1: For the DEV build, do not use the official community plugin entry `https://obsidian.md/plugins?id=remotely-save`, because it installs the stable plugin and does not give you the isolated DEV package.
- Option #2: You can also use [Obsidian42 - BRAT](https://github.com/TfTHacker/obsidian42-brat) to install this DEV plugin. Input `Flutter233PM/remotely-save` in the configuration of BRAT, and verify the installed plugin id is `remotely-save-dev`.
- Option #3: [![GitHub release (latest by SemVer and asset including pre-releases)](https://img.shields.io/github/downloads-pre/Flutter233PM/remotely-save/latest/main.js?sort=semver)](https://github.com/Flutter233PM/remotely-save/releases) Manually download the DEV assets (`main.js`, `manifest.json`, `styles.css`) from the latest release, and verify `manifest.json` uses id `remotely-save-dev`.
- Option #4: [![BuildCI](https://github.com/fyears/remotely-save/actions/workflows/auto-build.yml/badge.svg)](https://github.com/fyears/remotely-save/actions/workflows/auto-build.yml) Every DEV artifact is placed in the "Summary" under every successful build. It is automatically generated by every commit and may break.
...
See [here](./docs/import_export_some_settings.md) for more details. DEV builds use the `obsidian://remotely-save-dev?...` namespace for import/export URIs.
